...
//         index++;
//       } else {
//         clearInterval(interval); // Ensure typing stops once text is fully displayed
//       }
//     }, speed);
...
//   return (
//     <p className="fs-5 pt-1 pt-lg-2 container">
//       {displayedText}
...
//           <motion.img
//             src={portfolioPic}
//             style={{ zIndex: "1", width: "200px", height: "300px" }}
//             alt="pic-of-me"
//             className="mt-5 mb-5 w-50 h-75 rounded mx-auto d-block"
//             initial={{ opacity: 0, scale: 0.8 }}
//             animate={{
...
//       <TypingText text="I am a front-end developer making great stuff happen since 2020! Currently building awesome web interfaces with React!" />
...
const Heading = () => {
  ...
  const fullText =
    "I am a front-end developer making great stuff happen since 2020! Currently building awesome web interfaces with React!";
